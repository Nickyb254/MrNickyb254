...
const Skills = ({items, title, subtitle, mykey}) => {
  ...
  return (  
    <div id="card" className='mt-4 mb-[10%] mb-[10%] lg:flex-1 max-w-[90vw] w-[95%] shrink-x-auto max-w-[90vw] sm:max-w-[40vw] sm:space-x-auto lg:space-x-auto lg:mx-4 mx-auto '>
